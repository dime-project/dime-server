 ...
 */
@Controller
@RequestMapping("/services/{said}/googleplus")
public class GooglePlusAuthenticationController extends OAuthAuthenticationController<GooglePlusServiceAdapter> {

	@RequestMapping(value = "/connect", method = RequestMethod.GET)
	public ModelAndView requestConnection(HttpSession session,  @PathVariable("said") String said) {
		return super.requestConnection(session, said, GooglePlusServiceAdapter.class);
	}
