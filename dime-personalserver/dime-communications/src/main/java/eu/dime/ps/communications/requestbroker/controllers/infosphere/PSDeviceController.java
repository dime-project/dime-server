...
public class PSDeviceController implements APIController {
	...
	private static final Logger logger = LoggerFactory.getLogger(PSDeviceController.class);
	...
	public Response<Device> postNewDevice(@PathParam("said") String said, Request request) {
		...
		logger.info("called API method: POST /dime/rest" + said +"/device/@me");
	...
	public Response<Device> updateDevice(@PathParam("said") String said,
		...
		logger.info("called API method: POST /dime/rest" + said +"/device/"+deviceId);
	...
	public Response<Entry> getAllCurrentUserDevices(@PathParam("said") String said)
		...
		logger.info("called API method: GET /dime/rest" + said +"/device/@me/@all");
	...
	public Response<Entry> getDevice(@PathParam("said") String said,
		...
		logger.info("called API method: GET /dime/rest" + said +"/device/"+deviceId);
	...
	public Response deleteDevice(@PathParam("said") String said,
		...
		logger.info("called API method: DELETE /dime/rest" + said +"/device/"+deviceId);
