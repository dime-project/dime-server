...
public class Ontology extends eu.dime.ps.semantic.model.nrl.Schema {

    /** http://www.semanticdesktop.org/ontologies/2007/08/15/nrl#Ontology */
    @SuppressWarnings("hiding")
	public static final URI RDFS_CLASS = new URIImpl("http://www.semanticdesktop.org/ontologies/2007/08/15/nrl#Ontology", false);
	 ...
	 */
	public static Ontology  getInstance(Model model, org.ontoware.rdf2go.model.node.Resource instanceResource) {
		return Base.getInstance(model, instanceResource, Ontology.class);
	}

	/**
	 * Create a new instance of this class in the model. 
	 * That is, create the statement (instanceResource, RDF.type, http://www.semanticdesktop.org/ontologies/2007/08/15/nrl#Ontology).
	 * @param model an RDF2Go model
	 * @param instanceResource an RDF2Go resource
	 *
	 ...
	 */
	public static ReactorResult<? extends Ontology> getAllInstances_as(Model model) {
		return Base.getAllInstances_as(model, RDFS_CLASS, Ontology.class );
	}

    /**
	 * Remove rdf:type Ontology from this instance. Other triples are not affected.
