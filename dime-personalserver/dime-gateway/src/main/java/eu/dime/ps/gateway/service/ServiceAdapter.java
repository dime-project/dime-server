...
public interface ServiceAdapter {
	...
	/**
	 * Retrieves the service identifier - this is the full URI identifier in form urn:account:<TYPE-ADAPTER>-<INTERNALID>
	 * 
	 * @return Unique internal Service Identifier for this serviceAdapter instance
	 */
	public String getIdentifier();
    public void setIdentifer(String identifier);

    /**
     * Sets the value of a service-specific di.me setting. This is saved in the policy manager in services.properties as both a adapter-specific setting, and in the adapter-specific SETTINGS json output string.
     * @param name
     * @param value
	 ...
	 * 
	 * Example: Contact c = (Contact) service.get("/profiles/{@me pid}/profileId/");
	 * 
	 * @param attribute
	 *            to retrieve
	 ...
	 *            to set
	 * @param value
	 *            Resources containing values to be transmitted to the service
	 * @throws AttributeNotSupportedException
	 * @throws ServiceNotAvailableException 
	 ...
	 * https://docs.google.com/spreadsheet/ccc?key=0Av-4EU0c8D8TdDlaZ0lmMEU5cS1pbGdGRlRmU255V1E
	 * 
	 * Example: Collection results = service.search("/persons/@me/@all", personWithOnlyNameAttribute);
	 * 
	 * @param attribute
	 *            to search against
	 * @param values
	 *            Resource containing only the values to be searched and no
	 *            other values
	 ...
	 * 
	 * @param attribute
	 *            to expect as answer from remote server
	 * @param value
	 *            to expect as answer from remote server
	 * @throws ServiceNotAvailableException 
	 */
