...
public abstract class ServiceAdapterBase implements ServiceAdapter {
	...
	/**
	 * Constructor
	 * Generates a random ID for the service adapter.
...
//    }
	 ...
	 * 
	 * @param attribute
	 *			The attribute to set (e.g. "/notification")
	 * @param value
	 *			The object to be posted to the remote server
	 * @throws AttributeNotSupportedException
	 * @throws ServiceNotAvailableException
	 */
	...
	/**
	 * Checks to make sure that the rate limit is not exceeded. This function should be
	 * called before sending any request to the twitter adapter.
	 * 
	 ...
	 * 
	 * @param attribute
	 *			The attribute to delete (e.g. "/notification")
	 * @throws AttributeNotSupportedException
	 * @throws ServiceNotAvailableException
	 */
